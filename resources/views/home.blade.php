...
<!-- Start Slider Area -->
        ...
        @foreach ($employees as $employee)
          <div class="col-3 ">
            <div class="single-team-member">
              <div class="team-img">
                <img src="{{$employee->image}}" alt="" width="100%" class="text-center">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="awesome-project-content">
          ...
          <div class="col-4 design development">
          ...
          <!-- single-awesome-project end -->
          <!-- single-awesome-project start -->
          <div class="col-4 photo development">
            <div class="single-awesome-project">
              <div class="awesome-img">
  ...
  <div class="suscribe-area">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-12 col-12 col-xs=12">
